    ...
    <el-dialog title="订单管理" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item  label="订单名称" prop="name">
          <el-input :disabled="true" v-model="form.name" placeholder="订单名称"></el-input>
        </el-form-item>
        ...
        <el-form-item label="接单商家" prop="managerId">
          <el-select :disabled=true style="width: 100%" v-model="form.businessId">
        ...
        <el-form-item label="订单总价" prop="amount">
          <el-input :disabled="true" v-model="form.amount" placeholder="订单总价"></el-input>
        </el-form-item>
        <el-form-item label="优惠金额" prop="discount">
          <el-input :disabled="true" v-model="form.discount" placeholder="优惠金额"></el-input>
        </el-form-item>
        <el-form-item label="实付款" prop="actual">
          <el-input :disabled="true" v-model="form.actual" placeholder="实付款"></el-input>
        </el-form-item>
